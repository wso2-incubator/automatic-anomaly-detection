...
public class XSumFunctionExtensionTestCase {

    private static final Logger log = Logger.getLogger(XSumFunctionExtensionTestCase.class);
    ...
    public void timeWindowBatchTest1() throws InterruptedException {
        ...
        String query = "" +
                "@info(name = 'query1') " +
                "from inputStream " +
                "select time, statistic:x(a, b) as x " +
        ...
        executionPlanRuntime.addCallback("outputStream", new StreamCallback() {
            ...
            public void receive(Event[] events) {
                for (Event ev : events) {
                    System.out.println("time: " + ev.getData()[0] + "\tx: " + ev.getData()[1]);
                }
            }
        });
