...
public class SDFunctionExtensionTestCase {

    private static final Logger log = Logger.getLogger(SDFunctionExtensionTestCase.class);
    ...
    public void timeWindowBatchTest1() throws InterruptedException {
        ...
        String inputStream = "" +
                "define stream inputStream (time long, x double, xx double, n int);";
        String query = "" +
                "@info(name = 'query1') " +
                "from inputStream " +
                "select time, statistic:sd(x, xx, n) as sd " +
        ...
        inputHandler.send(new Object[]{100l, 3d, 9d, 1});
        inputHandler.send(new Object[]{101l, 4d, 16d, 2});
        inputHandler.send(new Object[]{102l, 5d, 25d, 3});
    ...
    public void timeWindowBatchTest2() throws InterruptedException {
        ...
        String inputStream = "" +
                "define stream inputStream (time long, x long, xx long, n int);";
        String query = "" +
                "@info(name = 'query1') " +
                "from inputStream " +
                "select time, statistic:sd(x, xx, n) as sd " +
        ...
        inputHandler.send(new Object[]{100l, 3l, 9l, 1});
        inputHandler.send(new Object[]{101l, 4l, 16l, 2});
        inputHandler.send(new Object[]{102l, 5l, 25l, 3});
    ...
    public void timeWindowBatchTest3() throws InterruptedException {
        ...
        String inputStream = "" +
                "define stream inputStream (time long, x int, xx int, n int);";
        String query = "" +
                "@info(name = 'query1') " +
                "from inputStream " +
                "select time, statistic:sd(x, xx, n) as sd " +
        ...
        inputHandler.send(new Object[]{100l, 3, 9, 1});
        inputHandler.send(new Object[]{101l, 4, 16, 2});
        inputHandler.send(new Object[]{102l, 5, 25, 3});
    ...
    public void timeWindowBatchTest4() throws InterruptedException {
        ...
        String inputStream = "" +
                "define stream inputStream (time long, x float, xx float, n int);";
        String query = "" +
                "@info(name = 'query1') " +
                "from inputStream " +
                "select time, statistic:sd(x, xx, n) as sd " +
        ...
        inputHandler.send(new Object[]{100l, 3f, 9f, 1});
        inputHandler.send(new Object[]{101l, 4f, 16f, 2});
        inputHandler.send(new Object[]{102l, 5f, 25f, 3});
