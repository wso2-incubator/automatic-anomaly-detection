...
/*
* xx(a,b);
* Returns the sum of 'a*a' and 'b'.
* Accept Type(s): INT,LONG,FLOAT,DOUBLE
* Return Type(s): INT,LONG,FLOAT,DOUBLE
*/
public class XXSumFunctionExtension extends FunctionExecutor {

    private XXSumFunctionExtension xxSumFunction;
    ...
    protected Object execute(Object[] data) {
        return xxSumFunction.execute(data);
    }
    ...
    public Attribute.Type getReturnType() {
        return xxSumFunction.getReturnType();
    }
    ...
    private class XXSumFunctionExtensionDouble extends XXSumFunctionExtension {
        ...
        protected Object execute(Object[] data) {
            ...
            return inputVal1 * inputVal1 + inputVal2;
        }
    ...
    private class XXSumFunctionExtensionInt extends XXSumFunctionExtension {
    ...
    private class XXSumFunctionExtensionFloat extends XXSumFunctionExtension {
    ...
    private class XXSumFunctionExtensionLong extends XXSumFunctionExtension {
